...
function close_search_button() {
    ...
    $("#close_search").remove();
    $("#search_button").css("top", "32px");
    $("#search_button").css("right", "32px");
    $("#search_button").one("click", function () {
        ...
        $('body').append("<ion-icon id='close_search' class='clickable' name='close-circle-outline'></ion-icon>");
        $(this).css("top", "0");
        $(this).css("right", "0");
        $("input:text:visible:first").focus();
        $("#close_search").one("click", function () {
            close_search_button();
        });
    });
}
